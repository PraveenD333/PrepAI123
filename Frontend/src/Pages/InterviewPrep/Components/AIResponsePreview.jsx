                    ...
                    components={{
                        code({ node, className, children, ...props }) {
                            ...
                            return !isInline ? (
                                ...
                                <code className='px-1 py-0.5 bg-black rounded text-sm'{...props}>
                                    {children}
                                </code>
                            );
                        },
...
function CodeBlock({ code, language }) {
    ...
    return <div className='relative my-6 rounded-lg overflow-hidden bg-black border border-white'>
        <div className='flex items-center justify-between px-4 py-2 bg-black text-white border-b border-white'>
            ...
            <button
                onClick={copyCode}
                className='text-white hover:text-green-400 focus:outline-none relative group'
